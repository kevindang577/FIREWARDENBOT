...
def generate_launch_description():
    ...
    husky_vision_group = GroupAction([
        # Foliage Hazard Detection (Python version)
        Node(
            package='firewardenbot_vision',
            executable='foliage_hazard_node.py',
            name='husky_foliage_detection',
            namespace='husky',
            parameters=[{
            ...
            remappings=[
                ('/foliage_hazard/alert', '/husky/foliage_hazard/alert'),
                ('/foliage_hazard/location', '/husky/foliage_hazard/location'),
                ('/foliage_hazard/detected', '/husky/foliage_hazard/detected'),
                ('/foliage_hazard/debug_image', '/husky/foliage_hazard/debug_image')
            ]
        ),
        
        # Foliage Hazard Detection (C++ version)
        Node(
            package='firewardenbot_vision',
            executable='fast_foliage_detector',
            name='husky_fast_foliage_detector',
            namespace='husky',
            parameters=[{
                'camera_topic': husky_camera_topic,
                'confidence_threshold': 0.7,
