...
A comprehensive computer vision package for foliage hazard detection, object tracking, and environmental monitoring for both ground robots (Husky) and drones.

## Features

### 🌿 **Foliage Hazard Detection**
- **Multi-modal Detection**: Color-based analysis for dead/dry foliage, thermal imaging, and texture analysis
- **Real-time Processing**: C++ implementation for fast detection
- **Configurable Confidence**: Adjustable thresholds for different foliage types
- **Combination Methods**: Fuses multiple detection sources for higher accuracy
- **Risk Assessment**: Identifies potential fire hazards from vegetation conditions
